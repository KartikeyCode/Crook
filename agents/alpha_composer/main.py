...
from shared.schemas import AlphaRequest
from agents.alpha_composer.orchestrator import run_alpha
...
async def main():
    ...
    log.info("Alpha Composer agent listening...")
    await stream.listen()
